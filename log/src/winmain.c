...
case WM_SIZE:
 ...
 if ( m_initialized)
    ...
    case WM_CLOSE:
      if(MessageBox(hwnd,"Are you sure you want to exit? Any unsaved work will be lost","Exit",MB_OKCANCEL | MB_ICONEXCLAMATION | MB_DEFBUTTON2)==IDCANCEL) 
        return 0;
      break;
    case WM_DESTROY:
         PostQuitMessage (0) ;
...
//   trace=fopen("trace","w");
  ...
  hfont=CreateFont(8,6,0,0,0,0,0,0,DEFAULT_CHARSET,OUT_RASTER_PRECIS,CLIP_DEFAULT_PRECIS,DEFAULT_QUALITY,FIXED_PITCH | FF_DONTCARE,"Terminal");
  hfont1=CreateFont(12,8,0,0,0,0,0,0,DEFAULT_CHARSET,OUT_RASTER_PRECIS,CLIP_DEFAULT_PRECIS,DEFAULT_QUALITY,FIXED_PITCH | FF_DONTCARE,"Terminal");
